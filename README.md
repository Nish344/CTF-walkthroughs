...
| Simple CTF – TryHackMe VAPT Walkthrough | TryHackMe | Easy | Secure Documentation → Structured reporting with PoC evidence, Post-Exploitation → SSH login, privilege escalation, Network & Web Enumeration → `nmap`, `gobuster`, SQL Injection Exploitation → CVE-2019-9053, hash cracking (`john`) | [Open](TryHackMe/Easy/Simple_CTF.md) |
